...
IASTriggerExtension.prototype.next = function() {
  ...
  if (this.$triggerNext) {
  	this.$triggerNext.fadeOut(500, function() {
		jQuery(this).replaceWith(function() {
  
            return jQuery('<div class="ias-wrapper to-hide">'+dt_ias.dt_loading+'</div>').hide().fadeIn(100);
        });
